...
var CuponsComponent = (function () {
    ...
    CuponsComponent.prototype.ngOnInit = function () {
        this.formulario = this.formBuilder.group({
            ...
            activated: [null, []],
            privated: [null, []],
            amount: [null, [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["c" /* Validators */].required]],
    ...
    CuponsComponent.prototype.populate = function (cupon) {
        this.formulario.setValue({
            ...
            activated: cupon.activated === true || cupon.activated == 1 ? "1" : "0",
            privated: cupon.privated === true || cupon.privated == 1 ? "1" : "0"
        });
    };
    CuponsComponent.prototype.register = function () {
        ...
        if (this.formulario.valid) {
            if (this.formulario.get('name').value.startsWith("SF-")) {
                this.toastr.warning('', "Desculpe. Mas você não pode criar cupom que comece 'SF-'.");
                return false;
            }
